...
% metadados do PDF.
\title{Ambiente de Experimentação Simulado para Plataformas de Cidades Inteligentes}
\author{Lucas Kanashiro Duarte}
...
\hypersetup{
  pdfkeywords={cidades inteligentes, experimentação, simulação},
}
...
% for gerar a capa etc. manualmente, remova.
\input{conteudo/metadados-tese}
...
% usando as informações incluídas acima em metadados-tese. Se não quiser
% usar, remova.
