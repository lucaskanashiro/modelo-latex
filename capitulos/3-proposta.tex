...
Já na Figura \ref{fig:sequencia_eventos_atuacao}, outro diagrama de sequência é apresentado, mas agora demonstrando as atividades a serem executadas quando um evento de atuação é gerado pela plataforma.
